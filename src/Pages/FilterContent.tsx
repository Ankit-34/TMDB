...
const FilterContent: React.FC<FilterTypes> = ({ typeProp }) => {
  let type: string, filter: string | undefined;
  ...
  const fetchData = async () => {
    ...
    //   if (filter === "latest") setDataSource([res.data]);
    //   else setDataSource([...res.data.results]);
  ...
  return (
    <div className="f_content">
      <div className="type">
        {typeProp.charAt(0).toUpperCase() + typeProp.slice(1)} {filter_param}{" "}
        Shows
      </div>
